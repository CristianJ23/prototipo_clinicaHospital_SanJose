...
export const Login = ({ setUser }) => {
    ...
    //                     break;
    //                 case "medico":
    //                     navigate("/registro_historia"); // Página para médicos
    //                     break;
    //                 case "enfermera":
    ...
    //             // Si las credenciales son correctas, recibimos el rol
    //             const { role } = response.data;  // El backend debe devolver el rol del usuario
    //             login(role);  // Actualizamos el estado de autenticación con el rol recibido
    //             navigate("/inicio_medico");  // Redirige al usuario a la página de inicio
    //         } else {
    //             setError(true);  // Si las credenciales no son correctas, mostramos un error
    //         }
    //     } catch (error) {
