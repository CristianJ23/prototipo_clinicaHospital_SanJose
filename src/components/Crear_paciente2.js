...
const CrearPaciente2 = ({ onCancel = () => console.log("Cancelación predeterminada") }) => {
  ...
  return (
    <div className="main-container">
      ...
      <div className="sidebar">
        ...
        <div className="modulo" onClick={() => navigate("/crear-paciente2")}>
          <img src={crearPacienteImg} alt="Registro de Paciente" />
          <p>Registro de Paciente</p>
        </div>
        <div className="modulo" onClick={() => navigate("/")}>
